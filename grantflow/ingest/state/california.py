"""California state grant scraper — CKAN API (data.ca.gov)."""
...
class CaliforniaScraper(BaseStateScraper):
    """Fetch California grant records from the CKAN API at data.ca.gov."""
    ...
    def fetch_records(self) -> list[dict]:
        ...
        try:
            # Step 1: Discover the datastore resource ID from the package
    ...
    def normalize_record(self, raw: dict) -> dict | None:
        ...
        raw_agency = raw.get("Agency") or raw.get("agency_name")
